...
estimates <-  function(m, seed){
  ...
  #-------------------------
  psi <- c(-0.3 , 0.186305814, 0.421321419,  0, 0, 0,
           0.232626663, 0)
  alpha <- 0.05
  ...
  sim <- function(n_sim){
    ...
    #---------------------------------------------------
    WQS <- 0*X$lbpfos + 0.421321419* X$pfba + 0*X$pfda + 
       0*X$pfna + 0*X$lbpfhxs + 0.232626663*X$lbpfoa + 0*X$pfos + 
      0.173026 * X$pfda * X$pfna + 0.173026 * X$lbpfhxs * X$pfos * X$pfna
